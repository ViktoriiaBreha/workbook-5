...
public class LibrarySystem {
    ...
    private void movieMenu() {
        boolean isMovieMenu = true;
        while (isMovieMenu){      System.out.println("\n=== Movie Menu ===");
            ...
            switch (choice2){
                ...
                case 8:
                    break;
                default:
                    System.out.println("Invalid input. Try to choose number from menu");
    ...
    private void magazineMenu() {
        ...
        while(isMagazine){System.out.println("\n=== Magazine Menu ===");
    ...
    private void searchMovies() {
        System.out.print("Enter search term for movies (title, author, genre, or ISBN): ");
    ...
    private void searchMoviesByDirectory() {
        System.out.print("Enter directory name: ");
        String directory = scanner.nextLine();

        List<Movie> results = library.searchByDirector(directory);
        if (results.isEmpty()) {
            System.out.println("No movies found by directory: " + directory);
        } else {
            System.out.println("\n=== Movies by " + directory + " ===");
            for (Movie movie : results) {
                System.out.println(movie);
    ...
    private void searchMagazines() {
        System.out.print("Enter search term for magazine (title, author, genre, or ISBN): ");
        String query = scanner.nextLine();
